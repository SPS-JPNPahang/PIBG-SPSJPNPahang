// forms.js - PIBG @ SPS (UPDATED WITH ALL FIELDS)
// --------------------------------------------------
...
const FormUI = {
        ...
        document.getElementById("form-container").innerHTML = `
            <div class="space-y-6">
                ...
                <div class="bg-blue-50 p-4 rounded-lg">
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input id="f-kod" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500" placeholder="Contoh: CBA0001">
                        </div>
                        <div>
                            <label class="block text-sm font-medium mb-1">Emel Sekolah <span class="text-red-500">*</span></label>
                            <input id="f-email" type="email" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500" placeholder="sekolah@moe.edu.my">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-green-50 p-4 rounded-lg">
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input id="f-rujukan" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500" placeholder="Contoh: PIBG/001/2025">
                        </div>
                        <div>
                ...
                <div class="bg-purple-50 p-4 rounded-lg">
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <p class="text-xs text-gray-600 mt-1">Mesti 30 hari sebelum tarikh MAT</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium mb-1">Masa MAT <span class="text-red-500">*</span></label>
                            <input id="f-masamat" type="text" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-purple-500" placeholder="Contoh: 2.30 Petang">
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium mb-1">Tempat MAT <span class="text-red-500">*</span></label>
                            <input id="f-tempatmat" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-purple-500" placeholder="Contoh: Dewan Sekolah">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input id="f-jawatan" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-purple-500" placeholder="Contoh: Pengarah JPN Pahang">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-yellow-50 p-4 rounded-lg">
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input id="f-telefon" type="tel" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-yellow-500" placeholder="Contoh: 012-3456789">
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-end">
                    <button id="btn-hantar" class="btn-primary px-8 py-3 rounded-lg font-semibold flex items-center gap-2">
    ...
    submitForm: async function () {
        ...
        const masaMAT = document.getElementById("f-masamat").value.trim();
        ...
        // Validate
        if (!kod || !email || !rujukan || !tarikhSurat || !tarikhMAT || !masaMAT || 
            !tempatMAT || !perasmi || !jawatan || !penghubung || !telefon) {
